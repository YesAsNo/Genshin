...
public class ToolGUI extends JFrame {
     ...
     */
    public static final TreeMap<WeeklyTalentMaterial, Set<Character>> farmedWeeklyTalentMaterials = new TreeMap<>(new ItemComparator());
        ...
        try {
            for (File savedCard : savedCards) {
                ...
                if (card.getTalentStatus()) {
                    ...
                    farmedWeeklyTalentMaterials.get(getWeeklyTalentMaterial(getCharacter(card.getCharacterName()).weeklyTalentMaterial))
                            .add(getCharacter(card.getCharacterName()));
                }
