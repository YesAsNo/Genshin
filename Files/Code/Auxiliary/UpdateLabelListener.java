...
public class UpdateLabelListener implements ActionListener {
     ...
     */
    public UpdateLabelListener(javax.swing.JLabel nameLabel, javax.swing.JLabel iconLabel, JCheckBox checkBox,
                               ToolData.RESOURCE_TYPE RESOURCE_TYPE) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (item.equalsIgnoreCase(EMPTY_SET_SELECTOR) || item.equalsIgnoreCase(EMPTY_WEAPON_SELECTOR)) {
            ...
            if (SELECTION_BOX_TYPE == ToolData.RESOURCE_TYPE.ARTIFACT) {
            ...
            if (SELECTION_BOX_TYPE == ToolData.RESOURCE_TYPE.WEAPON_NAME) {
