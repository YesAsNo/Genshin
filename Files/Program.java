...
public class Program extends JFrame implements ActionListener {
    ...
    private void $$$setupUI$$$() {
        ...
        panel9.setLayout(new GridLayoutManager(4, 1, new Insets(20, 5, 0, 5), -1, -1));
        ...
        panel9.add(label28, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        MonThu_Tab.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        MonThu_Tab.setBackground(new Color(-1));
        tabbedPane1.addTab("", new ImageIcon(getClass().getResource("/Files/Images/Weapon Materials/All Aerosiderite.png")), MonThu_Tab);
        final JScrollPane scrollPane3 = new JScrollPane();
        MonThu_Tab.add(scrollPane3, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        ...
        panel12.setLayout(new GridLayoutManager(3, 4, new Insets(10, 5, 20, 5), -1, -1));
        ...
        panel12.add(label30, new GridConstraints(2, 3, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel12.add(label31, new GridConstraints(2, 2, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel12.add(label32, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel12.add(label33, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JPanel panel13 = new JPanel();
        panel13.setLayout(new GridLayoutManager(1, 4, new Insets(0, 0, 0, 0), -1, -1));
        panel13.setBackground(new Color(-1));
        panel12.add(panel13, new GridConstraints(0, 0, 1, 4, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JPanel panel14 = new JPanel();
        panel14.setLayout(new GridBagLayout());
        panel14.setBackground(new Color(-1));
        panel13.add(panel14, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JLabel label34 = new JLabel();
        Font label34Font = this.$$$getFont$$$("Source Code Pro", Font.BOLD, -1, label34.getFont());
        if (label34Font != null) label34.setFont(label34Font);
        label34.setHorizontalAlignment(0);
        label34.setHorizontalTextPosition(0);
        label34.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Weapons/Bow_5star/Elegy for the End.png")));
        label34.setText("[ Weapon Name ]");
        label34.setVerticalAlignment(0);
        label34.setVerticalTextPosition(3);
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridheight = 2;
        ...
        Font label35Font = this.$$$getFont$$$("Source Code Pro Black", -1, 14, label35.getFont());
        if (label35Font != null) label35.setFont(label35Font);
        label35.setForeground(new Color(-13494016));
        label35.setText(" Characters ");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        Font label36Font = this.$$$getFont$$$("Source Code Pro", -1, 12, label36.getFont());
        if (label36Font != null) label36.setFont(label36Font);
        label36.setForeground(new Color(-26768));
        label36.setRequestFocusEnabled(false);
        label36.setText("[ Names ]");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.weightx = 1.0;
        ...
        panel13.add(panel15, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        gbc.gridheight = 2;
        gbc.anchor = GridBagConstraints.NORTH;
        panel15.add(label37, gbc);
        final JLabel label38 = new JLabel();
        Font label38Font = this.$$$getFont$$$("Source Code Pro Black", -1, 14, label38.getFont());
        if (label38Font != null) label38.setFont(label38Font);
        label38.setForeground(new Color(-13494016));
        label38.setText(" Characters ");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        panel13.add(panel16, new GridConstraints(0, 1, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JLabel label40 = new JLabel();
        Font label40Font = this.$$$getFont$$$("Source Code Pro", Font.BOLD, -1, label40.getFont());
        if (label40Font != null) label40.setFont(label40Font);
        label40.setHorizontalAlignment(0);
        label40.setHorizontalTextPosition(0);
        label40.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Weapons/Bow_5star/Elegy for the End.png")));
        label40.setText("[ Weapon Name ]");
        label40.setVerticalAlignment(0);
        label40.setVerticalTextPosition(3);
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridheight = 2;
        ...
        Font label41Font = this.$$$getFont$$$("Source Code Pro Black", -1, 14, label41.getFont());
        if (label41Font != null) label41.setFont(label41Font);
        label41.setForeground(new Color(-13494016));
        label41.setText(" Characters ");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        gbc.anchor = GridBagConstraints.NORTH;
        gbc.insets = new Insets(15, 0, 0, 0);
        panel16.add(label41, gbc);
        final JLabel label42 = new JLabel();
        Font label42Font = this.$$$getFont$$$("Source Code Pro", -1, 12, label42.getFont());
        if (label42Font != null) label42.setFont(label42Font);
        label42.setForeground(new Color(-26768));
        label42.setRequestFocusEnabled(false);
        label42.setText("[ Names ]");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.weightx = 1.0;
        ...
        gbc.anchor = GridBagConstraints.NORTH;
        gbc.insets = new Insets(5, 0, 0, 0);
        panel16.add(label42, gbc);
        final JPanel panel17 = new JPanel();
        panel17.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        panel17.setBackground(new Color(-1));
        panel12.add(panel17, new GridConstraints(1, 0, 1, 4, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JPanel panel18 = new JPanel();
        panel18.setLayout(new GridLayoutManager(3, 4, new Insets(10, 0, 10, 0), -1, -1));
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel11.add(panel18, gbc);
        final JLabel label43 = new JLabel();
        Font label43Font = this.$$$getFont$$$("Source Code Pro", Font.BOLD, -1, label43.getFont());
        if (label43Font != null) label43.setFont(label43Font);
        label43.setHorizontalAlignment(0);
        label43.setHorizontalTextPosition(0);
        label43.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Weapons/Bow_5star/Elegy for the End.png")));
        label43.setText("[ Weapon Name ]");
        label43.setVerticalAlignment(0);
        label43.setVerticalTextPosition(3);
        panel18.add(label43, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label44 = new JLabel();
        Font label44Font = this.$$$getFont$$$("Source Code Pro", Font.BOLD, -1, label44.getFont());
        if (label44Font != null) label44.setFont(label44Font);
        label44.setHorizontalAlignment(0);
        label44.setHorizontalTextPosition(0);
        label44.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Weapons/Bow_5star/Elegy for the End.png")));
        label44.setText("[ Weapon Name ]");
        label44.setVerticalAlignment(0);
        label44.setVerticalTextPosition(3);
        panel18.add(label44, new GridConstraints(2, 3, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label45 = new JLabel();
        Font label45Font = this.$$$getFont$$$("Source Code Pro", Font.BOLD, -1, label45.getFont());
        if (label45Font != null) label45.setFont(label45Font);
        label45.setHorizontalAlignment(0);
        label45.setHorizontalTextPosition(0);
        label45.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Weapons/Bow_5star/Elegy for the End.png")));
        label45.setText("[ Weapon Name ]");
        label45.setVerticalAlignment(0);
        label45.setVerticalTextPosition(3);
        panel18.add(label45, new GridConstraints(2, 2, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label46 = new JLabel();
        Font label46Font = this.$$$getFont$$$("Source Code Pro", Font.BOLD, -1, label46.getFont());
        if (label46Font != null) label46.setFont(label46Font);
        label46.setHorizontalAlignment(0);
        label46.setHorizontalTextPosition(0);
        label46.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Weapons/Bow_5star/Elegy for the End.png")));
        label46.setText("[ Weapon Name ]");
        label46.setVerticalAlignment(0);
        label46.setVerticalTextPosition(3);
        panel18.add(label46, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JPanel panel19 = new JPanel();
        panel19.setLayout(new GridLayoutManager(1, 4, new Insets(0, 0, 0, 0), -1, -1));
        panel19.setBackground(new Color(-1));
        panel18.add(panel19, new GridConstraints(0, 0, 1, 4, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JPanel panel20 = new JPanel();
        panel20.setLayout(new GridBagLayout());
        panel20.setBackground(new Color(-1));
        panel19.add(panel20, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JLabel label47 = new JLabel();
        Font label47Font = this.$$$getFont$$$("Source Code Pro", Font.BOLD, -1, label47.getFont());
        if (label47Font != null) label47.setFont(label47Font);
        label47.setHorizontalAlignment(0);
        label47.setHorizontalTextPosition(0);
        label47.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Weapons/Bow_5star/Elegy for the End.png")));
        label47.setText("[ Weapon Name ]");
        label47.setVerticalAlignment(0);
        label47.setVerticalTextPosition(3);
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridheight = 2;
        gbc.anchor = GridBagConstraints.NORTH;
        panel20.add(label47, gbc);
        final JLabel label48 = new JLabel();
        Font label48Font = this.$$$getFont$$$("Source Code Pro Black", -1, 14, label48.getFont());
        if (label48Font != null) label48.setFont(label48Font);
        label48.setForeground(new Color(-13494016));
        label48.setText(" Characters ");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        Font label49Font = this.$$$getFont$$$("Source Code Pro", -1, 12, label49.getFont());
        if (label49Font != null) label49.setFont(label49Font);
        label49.setForeground(new Color(-26768));
        label49.setRequestFocusEnabled(false);
        label49.setText("[ Names ]");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.weightx = 1.0;
        ...
        panel19.add(panel21, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JLabel label50 = new JLabel();
        Font label50Font = this.$$$getFont$$$("Source Code Pro", Font.BOLD, -1, label50.getFont());
        if (label50Font != null) label50.setFont(label50Font);
        label50.setHorizontalAlignment(0);
        label50.setHorizontalTextPosition(0);
        label50.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Weapons/Bow_5star/Elegy for the End.png")));
        label50.setText("[ Weapon Name ]");
        label50.setVerticalAlignment(0);
        label50.setVerticalTextPosition(3);
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridheight = 2;
        gbc.anchor = GridBagConstraints.NORTH;
        panel21.add(label50, gbc);
        final JLabel label51 = new JLabel();
        Font label51Font = this.$$$getFont$$$("Source Code Pro Black", -1, 14, label51.getFont());
        if (label51Font != null) label51.setFont(label51Font);
        label51.setForeground(new Color(-13494016));
        label51.setText(" Characters ");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        gbc.anchor = GridBagConstraints.NORTH;
        gbc.insets = new Insets(15, 0, 0, 0);
        panel21.add(label51, gbc);
        final JLabel label52 = new JLabel();
        Font label52Font = this.$$$getFont$$$("Source Code Pro", -1, 12, label52.getFont());
        if (label52Font != null) label52.setFont(label52Font);
        label52.setForeground(new Color(-26768));
        label52.setRequestFocusEnabled(false);
        label52.setText("[ Names ]");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.weightx = 1.0;
        ...
        panel19.add(panel22, new GridConstraints(0, 1, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JLabel label53 = new JLabel();
        Font label53Font = this.$$$getFont$$$("Source Code Pro", Font.BOLD, -1, label53.getFont());
        if (label53Font != null) label53.setFont(label53Font);
        label53.setHorizontalAlignment(0);
        label53.setHorizontalTextPosition(0);
        label53.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Weapons/Bow_5star/Elegy for the End.png")));
        label53.setText("[ Weapon Name ]");
        label53.setVerticalAlignment(0);
        label53.setVerticalTextPosition(3);
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridheight = 2;
        gbc.anchor = GridBagConstraints.NORTH;
        panel22.add(label53, gbc);
        final JLabel label54 = new JLabel();
        Font label54Font = this.$$$getFont$$$("Source Code Pro Black", -1, 14, label54.getFont());
        if (label54Font != null) label54.setFont(label54Font);
        label54.setForeground(new Color(-13494016));
        label54.setText(" Characters ");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        gbc.anchor = GridBagConstraints.NORTH;
        gbc.insets = new Insets(15, 0, 0, 0);
        panel22.add(label54, gbc);
        final JLabel label55 = new JLabel();
        Font label55Font = this.$$$getFont$$$("Source Code Pro", -1, 12, label55.getFont());
        if (label55Font != null) label55.setFont(label55Font);
        label55.setForeground(new Color(-26768));
        label55.setRequestFocusEnabled(false);
        label55.setText("[ Names ]");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.weightx = 1.0;
        ...
        gbc.anchor = GridBagConstraints.NORTH;
        gbc.insets = new Insets(5, 0, 0, 0);
        panel22.add(label55, gbc);
        final JPanel panel23 = new JPanel();
        panel23.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        panel23.setBackground(new Color(-1));
        panel18.add(panel23, new GridConstraints(1, 0, 1, 4, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JLabel label56 = new JLabel();
        Font label56Font = this.$$$getFont$$$("Source Code Pro Black", Font.BOLD, 14, label56.getFont());
        if (label56Font != null) label56.setFont(label56Font);
        label56.setForeground(new Color(-13494016));
        label56.setText("Weapons that are unlisted");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.weightx = 1.0;
        gbc.anchor = GridBagConstraints.NORTH;
        panel11.add(label56, gbc);
        ...
        tabbedPane1.addTab("", new ImageIcon(getClass().getResource("/Files/Images/Weapon Materials/All Guyun.png")), TuesFri_Tab);
        ...
        tabbedPane1.addTab("", new ImageIcon(getClass().getResource("/Files/Images/Weapon Materials/All Mist Veiled Elixir.png")), WedSat_Tab);
        final JLabel label57 = new JLabel();
        Font label57Font = this.$$$getFont$$$("Source Code Pro", -1, 12, label57.getFont());
        if (label57Font != null) label57.setFont(label57Font);
        label57.setForeground(new Color(-13494016));
        label57.setText("Weapons listed for this domain: 34");
        panel9.add(label57, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label58 = new JLabel();
        Font label58Font = this.$$$getFont$$$("Source Code Pro", -1, 12, label58.getFont());
        if (label58Font != null) label58.setFont(label58Font);
        label58.setForeground(new Color(-13494016));
        label58.setText("All weapons that need it: 53");
        panel9.add(label58, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
