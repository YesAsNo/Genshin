...
public class Program extends JFrame implements ActionListener {
    ...
    private void $$$setupUI$$$() {
        ...
        TuesFri_Tab.setLayout(new GridLayoutManager(1, 3, new Insets(0, 0, 0, 0), -1, -1));
        ...
        TuesFri_Tab.add(panel7,
                new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL,
                        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null,
                        0, false));
        final JLabel label28 = new JLabel();
        label28.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Characters/Albedo.png")));
        label28.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        ...
        Font label29Font = this.$$$getFont$$$("Source Code Pro Black", -1, 18, label29.getFont());
        if (label29Font != null) {
            label29.setFont(label29Font);
        }
        label29.setText("Albedo");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        textPane1.setMaximumSize(new Dimension(100, 2147483647));
        textPane1.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        ...
        panel7.add(textPane1, gbc);
        final JPanel panel8 = new JPanel();
        panel8.setLayout(new GridBagLayout());
        TuesFri_Tab.add(panel8,
                new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL,
                        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null,
                        0, false));
        final JLabel label30 = new JLabel();
        label30.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Characters/Albedo.png")));
        label30.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        ...
        gbc.anchor = GridBagConstraints.SOUTHWEST;
        gbc.insets = new Insets(5, 5, 5, 5);
        panel8.add(label30, gbc);
        final JTextPane textPane2 = new JTextPane();
        textPane2.setMaximumSize(new Dimension(50, 2147483647));
        textPane2.setPreferredSize(new Dimension(50, 23));
        textPane2.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.insets = new Insets(0, 0, 5, 5);
        panel8.add(textPane2, gbc);
        final JLabel label31 = new JLabel();
        Font label31Font = this.$$$getFont$$$("Source Code Pro Semibold", -1, 12, label31.getFont());
        if (label31Font != null) {
            label31.setFont(label31Font);
        }
        label31.setText("Albedo");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.insets = new Insets(0, 5, 0, 0);
        panel8.add(label31, gbc);
        final JPanel panel9 = new JPanel();
        panel9.setLayout(new GridBagLayout());
        TuesFri_Tab.add(panel9,
                new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL,
                        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                        GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null,
                        0, false));
        final JLabel label32 = new JLabel();
        label32.setIcon(new ImageIcon(getClass().getResource("/Files/Images/Characters/Albedo.png")));
        label32.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        ...
        gbc.anchor = GridBagConstraints.SOUTHWEST;
        gbc.insets = new Insets(5, 5, 5, 5);
        panel9.add(label32, gbc);
        final JLabel label33 = new JLabel();
        Font label33Font = this.$$$getFont$$$("Source Code Pro Black", -1, 18, label33.getFont());
        if (label33Font != null) {
            label33.setFont(label33Font);
        }
        label33.setText("Albedo");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.insets = new Insets(0, 5, 0, 0);
        panel9.add(label33, gbc);
        final JTextPane textPane3 = new JTextPane();
        textPane3.setMaximumSize(new Dimension(100, 2147483647));
        textPane3.setText("");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
