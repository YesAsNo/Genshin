...
public class Program extends JFrame implements ActionListener {
    ...
    private void $$$setupUI$$$() {
        ...
        elementFilterBox.setBackground(new Color(-2702645));
        ...
        matchedLabel = new JLabel();
        Font matchedLabelFont = this.$$$getFont$$$("Source Code Pro Black", Font.BOLD, -1, matchedLabel.getFont());
        if (matchedLabelFont != null) {
            matchedLabel.setFont(matchedLabelFont);
        }
        matchedLabel.setForeground(new Color(-15072759));
        matchedLabel.setText("Matches: 35");
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        devCharacterTab.add(matchedLabel, gbc);
