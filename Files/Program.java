...
public class Program extends JFrame implements ActionListener {
    ...
    private void $$$setupUI$$$() {
        ...
        Font forFutureUpdatesContactTextPaneFont = this.$$$getFont$$$("Source Code Pro Semibold", -1, -1, devUpdatesTextPane.getFont());
        if (forFutureUpdatesContactTextPaneFont != null)
            devUpdatesTextPane.setFont(forFutureUpdatesContactTextPaneFont);
        ...
        panel2.add(devUpdatesTextPane, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
        ...
        Font thisIsAPersonalTextPaneFont = this.$$$getFont$$$("Source Code Pro Semibold", -1, -1, devInfoTextPane.getFont());
        if (thisIsAPersonalTextPaneFont != null) devInfoTextPane.setFont(thisIsAPersonalTextPaneFont);
        ...
        panel3.add(devInfoTextPane, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
