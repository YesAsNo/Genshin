...
public class Program extends JFrame implements ActionListener {
    ...
    private JTextPane thisIsAPersonalTextPane;
    private JTextPane forFutureUpdatesContactTextPane;
    ...
    private void $$$setupUI$$$() {
        ...
        forFutureUpdatesContactTextPane = new JTextPane();
        forFutureUpdatesContactTextPane.setBackground(new Color(-465419));
        Font forFutureUpdatesContactTextPaneFont = this.$$$getFont$$$("Source Code Pro Semibold", -1, -1, forFutureUpdatesContactTextPane.getFont());
        if (forFutureUpdatesContactTextPaneFont != null)
            forFutureUpdatesContactTextPane.setFont(forFutureUpdatesContactTextPaneFont);
        forFutureUpdatesContactTextPane.setForeground(new Color(-11071434));
        forFutureUpdatesContactTextPane.setMargin(new Insets(30, 20, 10, 10));
        forFutureUpdatesContactTextPane.setSelectionColor(new Color(-9555638));
        forFutureUpdatesContactTextPane.setText("For future updates contact one of us. Make sure to keep your save file!");
        panel2.add(forFutureUpdatesContactTextPane, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
        ...
        label2.setBackground(new Color(-465419));
        Font label2Font = this.$$$getFont$$$("Source Code Pro Semibold", -1, 18, label2.getFont());
        if (label2Font != null) label2.setFont(label2Font);
        label2.setForeground(new Color(-11071434));
        label2.setText("Linako (yes.as.no)");
        ...
        label3.setBackground(new Color(-465419));
        Font label3Font = this.$$$getFont$$$("Source Code Pro Semibold", -1, 18, label3.getFont());
        if (label3Font != null) label3.setFont(label3Font);
        label3.setForeground(new Color(-11071434));
        label3.setText("Precisi0n");
        ...
        label4.setBackground(new Color(-465419));
        Font label4Font = this.$$$getFont$$$("Source Code Pro Black", Font.BOLD, 20, label4.getFont());
        if (label4Font != null) label4.setFont(label4Font);
        label4.setForeground(new Color(-11071434));
        label4.setText("✨ Welcome to GDApp! ✨");
        ...
        thisIsAPersonalTextPane = new JTextPane();
        thisIsAPersonalTextPane.setBackground(new Color(-465419));
        thisIsAPersonalTextPane.setEditable(false);
        thisIsAPersonalTextPane.setFocusable(false);
        Font thisIsAPersonalTextPaneFont = this.$$$getFont$$$("Source Code Pro Semibold", -1, -1, thisIsAPersonalTextPane.getFont());
        if (thisIsAPersonalTextPaneFont != null) thisIsAPersonalTextPane.setFont(thisIsAPersonalTextPaneFont);
        thisIsAPersonalTextPane.setForeground(new Color(-11071434));
        thisIsAPersonalTextPane.setMargin(new Insets(30, 20, 10, 10));
        thisIsAPersonalTextPane.setText("This is a personal project to make our daily tasks a little bit more coordinated! Here's how to get started!\n\n-\uD83D\uDD38✨ Character Tab ✨\uD83D\uDD38-\n\n- Search by name, filter or type \"debug\" to see all characters\n- Fill in the desired information (2nd artifact set is optional)\n- Checkboxes exist for characters to show up in the domains tab. Unchecking will hide a character from its chosen materials, making it easier to tell who still needs those materials. For example, if a character is done with its talents, you should uncheck the character.\n\n-\uD83D\uDD38✨ Weapon Tab ✨\uD83D\uDD38-\n\n- Search by name, filter or type \"debug\" to see all weapons.\n- Only checkboxes appear. Checking a weapon will make it show up in farmed items in domains.\n\n-\uD83D\uDD38✨ Domains Tab ✨\uD83D\uDD38-\n\n- Search by name, filter or type \"debug\" to see all domains.\n- The chosen domain will show all characters/weapons checked in other tabs.");
        panel3.add(thisIsAPersonalTextPane, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
