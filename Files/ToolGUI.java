...
public class ToolGUI extends JFrame {
    ...
    private void $$$setupUI$$$() {
        ...
        Font domainFilterBoxFont = this.$$$getFont$$$("Source Code Pro Black", Font.BOLD, -1, domainFilterBox.getFont());
        if (domainFilterBoxFont != null) domainFilterBox.setFont(domainFilterBoxFont);
